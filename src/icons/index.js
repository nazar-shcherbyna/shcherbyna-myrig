export const CheckMark = () => <svg width="13" height="9" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Pencil = () => <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
...
export const TrashCan = () => <svg xmlns="http://www.w3.org/2000/svg" width="23" height="24" fill="none" viewBox="0 0 23 24">
...
export const Arrow = (props) => <svg style={{transform: props.type === 'right' ? 'rotateY(180deg)' : ''}} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.82843 8.99999L12.0711 13.2426L10.6569 14.6568L5.00001 8.99999L10.6569 3.34314L12.0711 4.75735L7.82843 8.99999Z" fill="#4C4C4C"/>
</svg>